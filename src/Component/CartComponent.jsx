                    ...
                    <div className="cartpaymenth">
                        <Row className="cart-like" style={{ display: "flex", width: "100%" }}>
                            ...
                            <Col className="cartproduc" style={{ fontSize: "30px" }}>
                                ...
                                <div className="form-group">
                                    <label htmlFor="txtCustomerPhone">Số điện thoại</label>
                                    <input type="text" className="required form-control" id="phone" placeholder="Vui Lòng" onChange={(e) => setPhone(e.target.value)} />
                                </div>
                                <div className="form-group">
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        ...
                                        placeholder="Nhập nội dung bạn cần ghi chú"
                                        value={note}
